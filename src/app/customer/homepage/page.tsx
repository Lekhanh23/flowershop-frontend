...
  }, []);
  ...
  // START: SỬA ĐỔI CHÍNH Ở ĐÂY
  return (
    <div>
      {/* Hero Section (Không đổi) */}
      <section className={styles.heroSection}>
        {/* ... (Code Hero Section không đổi) ... */}
...
      {/* Bestsellers Section (SỬA ĐỔI CẤU TRÚC) */}
      <section className={styles.bestsellersSection}>
        <h2 className={styles.sectionTitle}>Our Bestsellers</h2>
        
        {/* KHỐI 1: CHỈ CÓ 4 SẢN PHẨM, VẪN DÙNG productGrid */}
        <div className={styles.bestsellersProductGrid}>
          {bestsellers.map((product) => (
            <ProductCard key={product.id} {...product} />
          ))}
        </div>

        {/* KHỐI 2: VIEW ALL - Độc lập, nằm ở dòng mới và được căn giữa */}
...
      </section>
      {/* END: SỬA ĐỔI CHÍNH Ở ĐÂY */}

      {/* Collections Section (Không đổi) */}
      <section className={styles.collectionsSection}>
        {/* ... (Code Collections Section không đổi) ... */}
...
      {/* Content Section (Không đổi) */}
      <section className={styles.contentSection}>
        {/* ... (Code Content Section không đổi) ... */}
