        ...
        <div className={styles.statGrid}>
          ...
          <div className={styles.statCardFull}>
            ...
            <table className={styles.recentTable}>
              ...
              <tbody>
                <tr><td>1023</td><td>Nguyen A</td><td>$120</td><td><span className={styles.statusCompleted}>Completed</span></td></tr>
                <tr><td>1022</td><td>Tran B</td><td>$85</td><td><span className={styles.statusPending}>Pending</span></td></tr>
                <tr><td>1021</td><td>Le C</td><td>$230</td><td><span className={styles.statusCompleted}>Completed</span></td></tr>
                <tr><td>1020</td><td>Pham D</td><td>$42</td><td><span className={styles.statusCancelled}>Cancelled</span></td></tr>
                <tr><td>1019</td><td>Hoang E</td><td>$150</td><td><span className={styles.statusCompleted}>Completed</span></td></tr>
              </tbody>
            </table>
          </div>
        </div>
